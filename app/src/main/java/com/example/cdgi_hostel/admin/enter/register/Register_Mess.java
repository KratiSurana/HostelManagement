...
public class Register_Mess extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Spinner spinnerState,spinnerCity,spinnerIdProof;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register__mess);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(FirstName.isEmpty()||Contact.isEmpty())
                    Toast.makeText(Register_Mess.this, "Fill Name and Contact", Toast.LENGTH_SHORT).show();
                else {
                    if (Password.equals(ConfirmPassword))
                    {
                        Boolean checkMess = DB.checkMess(Contact);
                        if (!checkMess) {
                            Boolean insert = DB.insertMessData(FirstName, LastName, Password
                                    , Address, Pincode, DOB, Email
                                    , Contact, EmergencyContactNumber, CollegeId, Experience,Id,State,City,IdProof,Gender);

                            if (insert) {
                                Toast.makeText(Register_Mess.this, "Registered Successfully", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                                startActivity(intent);
                            } else {
                                Toast.makeText(Register_Mess.this, "Registration Failed", Toast.LENGTH_SHORT).show();
                            }

                        } else {
                            Toast.makeText(Register_Mess.this, "Already registered", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(Register_Mess.this, "Password do not match", Toast.LENGTH_SHORT).show();
                    }
