...
public class Register_Manager extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register__manager);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(FirstName.isEmpty()||Contact.isEmpty())
                    Toast.makeText(Register_Manager.this, "Fill Name and Contact", Toast.LENGTH_SHORT).show();
                else
                {
                    if(Password.equals(ConfirmPassword))
                    {
                        Boolean checkManager = DB.checkManager(Contact);
                        if(!checkManager)
                        {
                            Boolean insert = DB.insertManagerData(FirstName,LastName,Password,Address,Pincode,DOB,Email
                                    , Contact, EmergencyContactNUmber,CollegeId, Experience,Id,State,City,HostelType,IdProof,Gender);

                            if(insert)
                            {
                                Toast.makeText(Register_Manager.this, "Registered Successfully", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(getApplicationContext(),MainActivity.class);
                                startActivity(intent);
                            }
                            else
                            {
                                Toast.makeText(Register_Manager.this, "Registration Failed", Toast.LENGTH_SHORT).show();
                            }

                        }
                        else
                        {
                            Toast.makeText(Register_Manager.this,"Already registered",Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
                        Toast.makeText(Register_Manager.this, "Password do not match", Toast.LENGTH_SHORT).show();
                    }
